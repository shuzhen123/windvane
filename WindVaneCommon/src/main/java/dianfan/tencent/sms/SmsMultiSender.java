...
public class SmsMultiSender {
	...
	/**
	 * 普通群发，明确指定内容，如果有多个签名，请在内容中以【】的方式添加到信息内容中，否则系统将使用默认签名 【注意】海外短信无群发功能
	 * 
	 * @param type
	 *            短信类型，0 为普通短信，1 营销短信
	 * @param nationCode
	...
	public SmsMultiSenderResult send(int type, String nationCode, ArrayList<String> phoneNumbers, String msg,
		 ...
		 * "nationcode": "86", "mobile": "13788888889" } ], "type": 0, "msg":
		 * "你的验证码是1234", "sig": "fdba654e05bc0d15796713a1a1a2318c", "time": 1479888540,
		 * "extend": "", "ext": "" } 应答包体 { "result": 0, "errmsg": "OK", "ext": "",
		 * "detail": [ { "result": 0, "errmsg": "OK", "mobile": "13788888888",
		 * "nationcode": "86", "sid": "xxxxxxx", "fee": 1 }, { "result": 0, "errmsg":
		 * "OK", "mobile": "13788888889", "nationcode": "86", "sid": "xxxxxxx", "fee": 1
		 * } ] }
		 */
		// 校验 type 类型
		if (0 != type && 1 != type) {
	 ...
	 * @throws Exception
	 */
	public SmsMultiSenderResult sendWithParam(String nationCode, ArrayList<String> phoneNumbers, int templId,
			ArrayList<String> params, String sign, String extend, String ext) throws Exception {
		/*
		 * 请求包体 { "tel": [ { "nationcode": "86", "mobile": "13788888888" }, {
		 * "nationcode": "86", "mobile": "13788888889" } ], "sign": "腾讯云", "tpl_id": 19,
		 * "params": [ "验证码", "1234", "4" ], "sig": "fdba654e05bc0d15796713a1a1a2318c",
		 * "time": 1479888540, "extend": "", "ext": "" } 应答包体 { "result": 0, "errmsg":
		 * "OK", "ext": "", "detail": [ { "result": 0, "errmsg": "OK", "mobile":
		 * "13788888888", "nationcode": "86", "sid": "xxxxxxx", "fee": 1 }, { "result":
		 * 0, "errmsg": "OK", "mobile": "13788888889", "nationcode": "86", "sid":
		 * "xxxxxxx", "fee": 1 } ] }
		 */
