...
public class HttpClientHelper {
		...
		try {
			...
			if (br != null) {
				try {
					 ...
					 * finally { if (con != null) { con.disconnect(); con = null; } }
					 */
			}
		}
		return resultBuffer.toString();
	 ...
	 */
	public static String httpClientPost(String urlParam, Map<String, String> params, String charset) {
		StringBuffer resultBuffer = null;
